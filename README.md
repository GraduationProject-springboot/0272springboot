...
![论坛](/md/blog.011.jpeg "论坛")
图4.4 论坛实体属性图

（5）下图是百科信息实体和其具备的属性。

![百科信息](/md/blog.012.jpeg "百科信息")
图4.5 百科信息实体属性图

（6）下图是商品实体和其具备的属性。

![商品](/md/blog.013.jpeg "商品")
图4.6 商品实体属性图

（7）下图是商品收藏实体和其具备的属性。

![商品收藏](/md/blog.014.jpeg "商品收藏")
图4.7 商品收藏实体属性图

（8）下图是商品评价实体和其具备的属性。

![商品评价](/md/blog.015.jpeg "商品评价")
图4.8 商品评价实体属性图

（9）下图是商品订单实体和其具备的属性。

![商品订单](/md/blog.016.jpeg "商品订单")
图4.9 商品订单实体属性图

（10）下图是收货地址实体和其具备的属性。

![收货地址](/md/blog.017.jpeg "收货地址")
图4.10 收货地址实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|baike\_name|String|百科名称|是|
|3|baike\_photo|String|百科图片|是|
|4|baike\_types|Integer|百科类型|是|
|5|insert\_time|Date|百科发布时间|是|
|6|baike\_content|String|百科详情|是|
